...
class TestMemory(unittest.TestCase):
    ...
    def test_select_record(self):
        ...
        cases = [
            {"name": "Выбор без фильтров", "filters": {}, "expected": test_datas},
            {"name": "Фильтр по ID", "filters": {"student_id": 1}, "expected": [test_datas[0]]},
            {"name": "Фильтр по имени", "filters": {"first_name": "Jane"}, "expected": [test_datas[1]]},
            {"name": "Фильтр по возрасту", "filters": {"age": 19}, "expected": [test_datas[2]]},
        ]
